...
export default function Detail_disabilitas({ navigation }) {
  ...
  const [items, setItems] = useState([
    ...
    { label: "Non Disabilitas", value: "non disabilitas" },
  ]);
  // Adjust width of Kode Wilayah column (second column) to be smaller
  const widthArr = [80, 100, 300, 120, 200, 150]; // Shrinking Kode Wilayah column to 120
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        // Jika kategori sudah dipilih sebelumnya, filter data sesuai dengan kategori
        if (category) {
    ...
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        >
          ...
          />
          <Text style={styles.headerTitle}>Data Kondisi Fisik</Text>
        </TouchableOpacity>
      </View>

      <Text style={styles.title}>DATA KONDISI FISIK WARGA GKJ DAYU</Text>
